...
const navLinks = [
  { href: "#home", label: "Home", isStatic: false },
              ...
              <div className="hidden md:flex items-center gap-1">
                {navLinks.map((link, i) => {
                  ...
                  const linkProps = {
                    ...
                    style: {
                      color: isLinkActive ? "hsl(43,100%,60%)" : "rgba(255,255,255,0.72)",
                    },
                  ...
                  const child = (
                    <>
                      ...
                      <motion.span
                        ...
                        initial={{ scaleX: isLinkActive ? 1 : 0 }}
                        animate={{ scaleX: isLinkActive ? 1 : 0 }}
                        whileHover={{ scaleX: 1 }}
                  ...
                  return link.isStatic ? (
                    <Link
                      key={link.href}
                      to={link.href}
                      {...linkProps}
                      className={`${linkProps.className} hover:text-[hsl(43,100%,65%)]`}
                    >
                      {child}
                    </Link>
                  ) : (
              ...
              <div className="px-6 py-5 space-y-1">
                {navLinks.map((link, i) => {
                  ...
                  const linkProps = {
                    ...
                    style: {
                      color: isLinkActive ? "hsl(43,100%,55%)" : "rgba(255,255,255,0.75)",
                      background: isLinkActive ? "rgba(255,255,255,0.07)" : "transparent",
                    },
                  };
                  ...
                  const child = (
                    <>
                      <span
                        ...
                        style={{ background: isLinkActive ? "hsl(43,100%,55%)" : "rgba(255,255,255,0.3)" }}
                      />
                      {link.label}
                    </>
                  );
